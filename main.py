...
color_list = ['orange', 'pink', 'blue', 'yellow']  # clockwise order of colors  
...
# --- spin to see who goes first ----------------------------------------------
    ...
    tie = False
    for p in range(4):
        initial_spin.append(spin())
        if initial_spin[p] > max_spin: 
            max_spin = initial_spin[p]
        elif max_spin == initial_spin[p]:
            tie = True
